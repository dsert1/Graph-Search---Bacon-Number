...
class TestTiny(unittest.TestCase):
    ...
    def test_acted_together_1(self):
        '''
        Tests to see if actor 1 and actor 2 acted together in tiny.pickle, when they did.
        Should return True.
        '''
        actor_1 = 1532
        actor_2 = 2876
        self.assertTrue(Bacon Number.acted_together(self.data, actor_1, actor_2))


    def test_acted_together_2(self):
        '''
        Tests to see if actor 1 and actor 2 acted together in tiny.pickle, when they didn't.
        Should return False.
        '''
        actor_1 = 1640
        actor_2 = 4724
        self.assertFalse(Bacon Number.acted_together(self.data, actor_1, actor_2))

    def test_acted_together_3(self):
        '''
        Tests to see if actor 1 and actor 2 acted together in tiny.pickle, when they did.
        Should return True.
        '''
    ...
    def test_bacon_number_0(self):
        '''
        This tester tests the Bacon Number 0 case.
        '''

        self.assertEqual(Bacon Number.actors_with_bacon_number(self.data, 0),{4724})

    def test_bacon_number_1(self):
        '''
        This tester tests the Bacon Number 1 case.
        '''

        self.assertEqual(Bacon Number.actors_with_bacon_number(self.data, 1),{2876, 1532})

    def test_bacon_number_2(self):
        '''
        This tester tests the Bacon Number 2 case.
        '''

        self.assertEqual(Bacon Number.actors_with_bacon_number(self.data, 2),{1640})

    def test_bacon_number_3(self):
        '''
        This tester tests the Bacon Number 3 case.
        '''

        self.assertEqual(Bacon Number.actors_with_bacon_number(self.data, 3),set())

    def test_bacon_path(self):
        '''
        Tests the Tiny Database Bacon Path.
        '''
        actor_id = 1640
        shortest_list = [4724, 2876, 1640]

        output = Bacon Number.bacon_path(self.data, actor_id)

        self.assertEqual(output, shortest_list)

    def test_actor_to_actor(self):
        '''
        Tests the Actor to Actor path function on the Tiny Pickle Database.
        '''
        actor_id_1 = 1532
        actor_id_2 = 1640
        shortest_list = [1532, 2876, 1640]

        output = Bacon Number.actor_to_actor_path(self.data, actor_id_1, actor_id_2)
...
class Test01_ActedTogether(unittest.TestCase):
    ...
    def test_01(self):
        ...
        actor1 = 4724
        actor2 = 9210
        self.assertTrue(Bacon Number.acted_together(self.data, actor1, actor2))

    def test_02(self):
        # Simple test, two actors who had not acted together
        actor1 = 4724
        actor2 = 16935
        self.assertFalse(Bacon Number.acted_together(self.data, actor1, actor2))
...
class Test02_BaconNumber(unittest.TestCase):
    ...
    def test_04(self):
        ...
        first_result = Bacon Number.actors_with_bacon_number(self.data, n)
        self.assertTrue(isinstance(first_result, set))
        self.assertEqual(first_result, expected)

        second_result = Bacon Number.actors_with_bacon_number(self.data, n)
    ...
    def test_06(self):
        ...
        self.assertEqual(len(Bacon Number.actors_with_bacon_number(make_bacon_tree(N, k), N)), k)

    def test_07(self):
        # random graph, Bacon number with no people
        N = random.randint(5, 10)
        k = random.randint(4, 7)
        self.assertEqual(len(Bacon Number.actors_with_bacon_number(make_bacon_tree(N, k), int(1e20))), 0)
        self.assertEqual(len(Bacon Number.actors_with_bacon_number(make_bacon_tree(N, k), int(1e20))), 0)
...
class Test03_BaconPath(unittest.TestCase):
    ...
    def test_08(self):
        ...
        first_result = Bacon Number.bacon_path(self.db_small, actor_id)
        self.assertEqual(first_result, expected)

        second_result = Bacon Number.bacon_path(self.db_small, actor_id)
        self.assertEqual(second_result, expected)
    ...
    def test_10(self):
        ...
        actor_id = 1204
        len_expected = 2
        result = Bacon Number.bacon_path(self.db_large, actor_id)
...
class Test04_ActorPath(unittest.TestCase):
    ...
    def test_14(self):
        ...
        first_result = Bacon Number.actor_to_actor_path(self.db_large, actor_1, actor_2)
        len_first_result = -1 if first_result is None else len(first_result)-1
        ...
        second_result = Bacon Number.actor_to_actor_path(self.db_large, actor_1, actor_2)
        len_second_result = -1 if second_result is None else len(second_result)-1
    ...
    def test_15(self):
        ...
        actor_2 = 57082
        len_expected = 4
        result = Bacon Number.actor_to_actor_path(self.db_large, actor_1, actor_2)
        len_result = -1 if result is None else len(result)-1
        self.assertTrue(valid_path(self.db_large, result))
        self.assertEqual(len_result, len_expected)
    ...
    def test_18(self):
        ...
        x = 1372398
        y = 62597
        p = Bacon Number.actor_to_actor_path(self.db_large, x, y)
    ...
    def test_20(self):
        ...
        x = e[0]
        y = e[-1]
        p = Bacon Number.actor_to_actor_path(data, x, y)
    ...
    def test_21(self):
        ...
        data = self.db_large[:]
        data.append((x, y, 0))
        p = Bacon Number.actor_to_actor_path(data, 4724, y)
...
class Test05_Path(unittest.TestCase):
    ...
    def test_22(self):
        result = Bacon Number.actor_path(self.db_large, 975260, lambda p: False)
        self.assertEqual(result, None)

    def test_23(self):
        result = Bacon Number.actor_path(self.db_large, 975260, lambda p: True)
        self.assertEqual(result, [975260])

        result2 = Bacon Number.actor_path(self.db_large, 975260, lambda p: p == 975260)
        self.assertEqual(result2, [975260])

    def test_24(self):
        ppl = {536472, 44795, 240045, 19534}
        result1 = Bacon Number.actor_path(self.db_large, 10526, lambda p: p in ppl)
        ...
        result2 = Bacon Number.actor_path(self.db_large, 10526, lambda p: p in ppl and p > 19534)
    ...
    def test_25(self):
        result = Bacon Number.actor_path(self.db_large, 152597, lambda p: p in {129507, 1400266, 1355798})
    ...
    def test_26(self):
        result = Bacon Number.actor_path(self.db_large, 26473, lambda p: p in {105656, 118946})
        self.assertNotEqual(result, None)
    ...
    def test_27(self):
        result = Bacon Number.actor_path(self.db_large, 129507, lambda p: p == 152597)
        self.assertNotEqual(result, None)
...
class Test06_ActorsConnectingFilms(unittest.TestCase):
    ...
    def check_connected_movie_path(self, m1, m2):
        ...
        for a, b, c in self.db_large:
            ...
            s.add(a)
            s.add(b)
        result = Bacon Number.actors_connecting_films(self.db_large, m1, m2)
        self.assertNotEqual(result, None)
