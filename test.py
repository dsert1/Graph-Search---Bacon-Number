...
class TestTiny(unittest.TestCase):
    ...
    def test_acted_together_2(self):
        ...
        actor_1 = 1640
        actor_2 = 4724
        self.assertFalse(lab.acted_together(self.data, actor_1, actor_2))
    ...
    def test_bacon_number_0(self):
        ...
        self.assertEqual(lab.actors_with_bacon_number(self.data, 0),{4724})
    ...
    def test_bacon_number_1(self):
        ...
        self.assertEqual(lab.actors_with_bacon_number(self.data, 1),{2876, 1532})
    ...
    def test_bacon_number_2(self):
        ...
        self.assertEqual(lab.actors_with_bacon_number(self.data, 2),{1640})
    ...
    def test_bacon_number_3(self):
        ...
        self.assertEqual(lab.actors_with_bacon_number(self.data, 3),set())
    ...
    def test_bacon_path(self):
        ...
        output = lab.bacon_path(self.data, actor_id)
    ...
    def test_actor_to_actor(self):
        ...
        output = lab.actor_to_actor_path(self.data, actor_id_1, actor_id_2)
